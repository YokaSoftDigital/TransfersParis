...
//////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////
const navLinks = document.querySelectorAll('#car-info, #window4-order,nav a,#window1-trigger-item-action,.modal-menu-list a');
...
var modalFormBg1 = document.getElementById("modal-form-bg1"),
	...
	modalFormBg1.style.width = d + 350 + "px";
	modalFormBg1.style.height = d + 350 + "px";
	...
	if (this.dataset.adressTo == "empty" || this.dataset.adressFrom == "empty" || this.dataset.time == "empty" || this.dataset.carclass == "empty" || this.dataset.passenger == "empty" || this.dataset.baggage == "empty") {
		...
		if (document.getElementById("window1-back-trip").classList.contains("active")) {
			if (modalTriger.dataset.trigerTime == "empty" || modalTriger.dataset.trigerAddress == "empty") {
				...
				setTimeout(function(){modalFormBg1.style.transform = "scale(1)";}, 100);
				setTimeout(function(){
...
document.getElementById("modal-form-close").addEventListener("click",function(){
	...
	setTimeout(function(){modalFormBg1.style.transform = "scale(0)";},500);
...
document.getElementById("header-call").addEventListener("click", function(){
	...
	setTimeout(function(){
		document.getElementById("modal-call-bg").style.transform = "scale(1)";
	},100);
	setTimeout(function(){
...
document.getElementById("close-modal-call").addEventListener("click", function(){
	...
	setTimeout(function(){
		document.getElementById("modal-call-bg").style.transform = "scale(0)";
	},100);
	setTimeout(function(){
...
document.getElementById("window7-link").addEventListener("click", function(){
	...
	setTimeout(function(){
		document.getElementById("modal-driver-bg").style.transform = "scale(1)";
	},100);
	setTimeout(function(){
...
document.getElementById("close-modal-driver").addEventListener("click", function(){
	...
	setTimeout(function(){
		document.getElementById("modal-driver-bg").style.transform = "scale(0)";
	},100);
	setTimeout(function(){
...
newsClose.addEventListener("click", function(){
	...
	setTimeout(function(){
		newsBg.style.transform = "scale(0)";
